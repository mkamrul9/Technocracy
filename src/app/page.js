...
const countMembers = (teams) => teams.reduce((total, team) => total + team.members.length, 0);

export default function Home() {
  const codeTeamCount = codeKachalTeams.length;
  const hackTeamCount = hackSparkTeams.length;
  const totalTeams = codeTeamCount + hackTeamCount;
  const codeMembers = countMembers(codeKachalTeams);
  const hackMembers = countMembers(hackSparkTeams);
  const totalMembers = codeMembers + hackMembers;
  ...
  return (
    <>
      ...
      <main id="main-content">
        ...
        <section id="teams-overview" className="sectionBlock teamSection" data-reveal>
          <div className="teamSectionHeader">
            <div>
              <p className="kicker">Competition Teams</p>
              <h2>Teams at a Glance</h2>
              <p className="sectionLead">Quick stats for both competitions, plus a direct link to the full list.</p>
            </div>
            <div className="teamSummary" aria-label="Team summary">
          ...
          <div className="teamOverviewGrid">
            <article className="teamOverviewCard">
              <p className="teamTag">Code Kachal</p>
              <h3>{codeTeamCount} Teams</h3>
              <p className="sectionLead">{codeMembers} Participants</p>
            </article>
            <article className="teamOverviewCard">
              <p className="teamTag">HackSpark</p>
              <h3>{hackTeamCount} Teams</h3>
              <p className="sectionLead">{hackMembers} Participants</p>
            </article>
          </div>

          <div className="teamOverviewCta">
            <a className="btnPrimary" href="/teams">
              View All Teams
            </a>
          </div>
        </section>
